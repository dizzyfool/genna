...
func TestColumn_GoName(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			c := NewColumn(tt.pgName, TypePGText, false, false, false, 0, false, false, 0, 0, []string{})
			if c.GoName != tt.want {
...
func TestColumn_GoType(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			c := NewColumn("test", tt.fields.pgType, tt.fields.nullable, tt.fields.sqlNulls, tt.fields.array, tt.fields.dims, false, false, 0, 0, []string{})
