...
func TestEntity_AddColumn(t *testing.T) {
	...
	t.Run("Should add column", func(t *testing.T) {
		column1 := NewColumn("name", TypePGText, false, false, false, 0, false, false, 0, 0, []string{})
		column2 := NewColumn("name_", TypePGText, false, false, false, 0, false, false, 0, 0, []string{})
		column3 := NewColumn("timeout", TypePGInterval, false, false, false, 0, false, false, 0, 0, []string{})
		column4 := NewColumn("duration", TypePGInterval, false, false, false, 0, false, false, 0, 0, []string{})
...
func TestEntity_AddRelation(t *testing.T) {
	column1 := NewColumn("test", TypePGText, false, false, false, 0, false, false, 0, 0, []string{})
...
func TestEntity_HasMultiplePKs(t *testing.T) {
	...
	t.Run("Should add column", func(t *testing.T) {
		column1 := NewColumn("userId", TypePGText, false, false, false, 0, true, false, 0, 0, []string{})
		column2 := NewColumn("locationId", TypePGText, false, false, false, 0, true, false, 0, 0, []string{})
